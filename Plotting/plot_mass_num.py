...
file = '../run/carma/hj_west_'+str(name)+'.txt'
...
ax4.set_yscale('log')
ax4.set_xscale('log')
ax4.set_ylim(1e2,min(p)/1.e6)
ax4.set_xlim(min(r[:,0]),max(r[:,0]))


file = '../run/carma/hj_day_'+str(name)+'.txt'
...
ax5.set_yscale('log')
ax5.set_xscale('log')
ax5.set_ylim(1e2,min(p)/1.e6)
ax5.set_xlim(min(r[:,0]),max(r[:,0]))

file = '../run/carma/hj_east_'+str(name)+'.txt'
