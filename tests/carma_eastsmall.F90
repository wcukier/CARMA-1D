...
!  real(kind=f), allocatable   :: ekz(:)
  ...
  character(len=100)	:: filename_restart = 'east_small'
  character(len=100)	:: filename = 'east_small'
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  open(12, file = 'w39b_east_centers.txt')
 ...
 open(13, file = 'w39b_east_levels.txt')
 
 do i=1, NZP1
   read(13,*) altl(i), prel(i)
 end do
 
 close(13)
 
 open(14, file = 'w39b_kzz_small.txt')
 ...
 close(14)
  ...
  grav(:) = 426._f !cm/s^2
  met = 1._f
  tio2_in = 2.4827666309909085e-07_f
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 ...
 !Fe on TiO2 cos(77.2) = 0.221548 from Gao+2020
  ...
  write(*,*) "  Add Coagulation ..."
  call CARMA_AddCoagulation(carma, 3, 3, 3, I_COLLEC_FUCHS, rc) 
  if (rc < 0) stop "    *** FAILED ***"
  
  write(*,*) "  Add Coagulation ..."
  call CARMA_AddCoagulation(carma, 4, 4, 4, I_COLLEC_FUCHS, rc) 
  if (rc < 0) stop "    *** FAILED ***"
  
  write(*,*) "  Add Coagulation ..."
  call CARMA_AddCoagulation(carma, 5, 5, 5, I_COLLEC_FUCHS, rc) 
  if (rc < 0) stop "    *** FAILED ***"
  
  write(*,*) "  Add Coagulation ..."
  call CARMA_AddCoagulation(carma, 6, 6, 6, I_COLLEC_FUCHS, rc) 
  if (rc < 0) stop "    *** FAILED ***"
  
  write(*,*) "  Add Coagulation ..."
  call CARMA_AddCoagulation(carma, 7, 7, 7, I_COLLEC_FUCHS, rc) 
  if (rc < 0) stop "    *** FAILED ***"
  
  write(*,*) "  Add Coagulation ..."
  call CARMA_AddCoagulation(carma, 8, 8, 8, I_COLLEC_FUCHS, rc) 
  if (rc < 0) stop "    *** FAILED ***"  
  
  write(*,*) "  Add Coagulation ..."
  call CARMA_AddCoagulation(carma, 9, 9, 9, I_COLLEC_FUCHS, rc) 
  if (rc < 0) stop "    *** FAILED ***"
  
  write(*,*) "  Add Coagulation ..."
  call CARMA_AddCoagulation(carma, 10, 10, 10, I_COLLEC_FUCHS, rc) 
  if (rc < 0) stop "    *** FAILED ***"
  
  
  write(*,*) "  Add Coagulation ..."
  call CARMA_AddCoagulation(carma, 11, 11, 11, I_COLLEC_FUCHS, rc) 
  if (rc < 0) stop "    *** FAILED ***"
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  call CARMA_Initialize(carma, rc, do_cnst_rlh =.FALSE., do_coag=.TRUE., do_fixedinit=.TRUE., do_grow=.TRUE., &
